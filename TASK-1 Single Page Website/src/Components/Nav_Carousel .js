      ...
      <>
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="navbar-brand mx-auto" navbar>
            <NavItem>
              <NavLink href="./"><span className="li">HOME</span></NavLink>
            </NavItem>
            <NavItem>
              <NavLink  href="./"><span className="li">PROJECTS</span></NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="./"><span className="li">PRICING</span></NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="./"><span className="li">TEAM</span></NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="./"><span className="li">BLOG</span></NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="./"><span className="li">CONTACT</span></NavLink>
            </NavItem>
            </Nav>
        </Collapse>
      </Navbar>
